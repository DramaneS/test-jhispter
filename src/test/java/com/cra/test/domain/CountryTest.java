...
import static com.cra.test.domain.CountryTestSamples.*;
import static com.cra.test.domain.LocationTestSamples.*;
import static com.cra.test.domain.RegionTestSamples.*;
